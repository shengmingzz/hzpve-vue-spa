<template>
    <section id='foot_guide'>
        ...
        <section @click = "gotoAddress('infomain')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('info') !== -1? '#infoActive' : '#info'"></use>
            </svg>
            <span>资讯</span>
        </section>
        <section @click = "gotoAddress('/tvmain')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('tv') !== -1? '#liveActive' : '#live'"></use>
            </svg>
            <span>视频</span>
        </section>
        <section @click = "gotoAddress('/forummain')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('forum') !== -1? '#postActive' : '#post'"></use>
            </svg>
            <span>贴吧</span>
        </section>
        <section @click = "gotoAddress('/pvpmain')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('pvp') !== -1? '#profileActive' : '#profile'"></use>
            </svg>
            <span>pvp</span>
        </section>
        <section @click = "gotoAddress('/pvemain')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('pve') !== -1? '#findActive' : '#find'"></use>
            </svg>
            <span>pve</span>
        </section>
    </section>
