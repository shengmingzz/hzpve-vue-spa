<template>
  <div id="app">
    ...
    <div v-for="(subitems,index) in starheros" :key="index">
      ...
      <div class="container">
        <a v-for="(item,key) in subitems" :key="key" class="cell-main" @click="clickHeroItem(item)">
          <img :src="item.icon" class="cell-img">
          <div class="cell-text">{{item.name}}</div>
        </a>
        <!-- <router-link :to="{path: '/hero', query: {code: item.code}}" v-for="(item,key) in subitems" :key="key" class="cell-main">
          <img :src="item.icon" class="cell-img">
          <div class="cell-text">{{item.name}}</div>
        </router-link> -->
      </div>
